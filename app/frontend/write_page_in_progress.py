...
keys_top3 = random.sample(range(1000,9999), 3)
...
def return_user_feelings(user_feelings_button=False) -> List:
    ...
    # there_is_no_emotions = col4.checkbox("원하는 감정이 없어요!", value=st.session_state["test2"], key=keys_top3[3], on_change=flip2)
    ...
    #         _, col3, _ = st.columns([2.7]*2+[1])
    #         _, col4, _ = st.columns([2.7]*2+[1])
    #         _, col5, _ = st.columns([2.7]*2+[1])
    #         option1 = col2.checkbox(emotions[0])
    #         option2 = col3.checkbox(emotions[1])
    #         option3 = col4.checkbox(emotions[2])
    #         index = [option1, option2, option3]
    ...
    # there_is_no_emotions = st.checkbox("원하는 감정이 없어요!", value=st.session_state["test2"], key="check2", on_change=flip2) 
    ...
    #     option2 = col3.checkbox(emotions[1])
    #     option3 = col4.checkbox(emotions[2])
    #     there_is_no_emotions = col5.checkbox("원하는 감정이 없어요!", value=st.session_state["test2"], key="check2", on_change=flip2) 
...
emotion_data = return_user_feelings(user_feelings_button)
final_selection = select_emotion_label(emotion_data)
print("fianl_selection: ", final_selection)
print("=================================== Success!!")
